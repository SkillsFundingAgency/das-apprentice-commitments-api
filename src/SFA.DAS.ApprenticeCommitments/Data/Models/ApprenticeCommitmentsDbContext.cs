...
namespace SFA.DAS.ApprenticeCommitments.Data.Models
{
    public class ApprenticeCommitmentsDbContext
        : DbContext, IRegistrationContext, IApprenticeshipContext, IRevisionContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Revision>()
                .OwnsOne(e => e.Details, details =>
                {
                    ...
                    details.Property(p => p.ApprenticeshipType).HasColumnName("ApprenticeshipType");
            ...
            modelBuilder.Entity<Registration>(entity =>
            {
                ...
                entity.OwnsOne(e => e.Approval, apprenticeship =>
                {
                    ...
                    apprenticeship.Property(p => p.ApprenticeshipType).HasColumnName("ApprenticeshipType");
