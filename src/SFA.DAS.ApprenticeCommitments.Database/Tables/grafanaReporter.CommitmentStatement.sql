CREATE TABLE [grafanaReporter].[CommitmentStatement]
(
...
CREATE INDEX [IX_CommitmentStatement_ApprenticeshipId] ON [grafanaReporter].[CommitmentStatement] ([ApprenticeshipId]);
GO